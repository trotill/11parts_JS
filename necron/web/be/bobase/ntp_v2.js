			...
			spage: {
				manual: [
					...
					},
					{
						...
						//],
						value: [['2018', '12', '14', '12', '40', '59']],
						items: [
							{
								name: 'Year',
								id: 'year',
								type: 'tfield',
								flt: { minmax: ['2018', '2118'], sym: ['zpn'] },
								fltsett: { event: false }, //eventFromUI disable
								value: '',
								stylize: {
									changeclass: {
										input: 'inputBase_inputW70'
									}
								}
								// css:'width:10%'
							},
							{
								...
								type: 'tfield',
								id: 'month',
								flt: { len: ['2', '2'], minmax: ['1', '12'], sym: ['zpn'] },
								fltsett: { event: false }, //eventFromUI disable
								value: '',
								stylize: {
									changeclass: {
							...
							},
							{
								...
								type: 'tfield',
								id: 'day',
								flt: { len: ['2', '2'], minmax: ['1', '31'], sym: ['zpn'] },
								fltsett: { event: false }, //eventFromUI disable
								value: '',
								stylize: {
									changeclass: {
							...
							},
							{
								...
								type: 'tfield',
								id: 'hour',
								flt: { len: ['2', '2'], minmax: ['0', '23'], sym: ['zpn'] },
								fltsett: { event: false }, //eventFromUI disable
								value: '',
								stylize: {
									changeclass: {
							...
							},
							{
								...
								id: 'min',
								type: 'tfield',
								flt: { len: ['2', '2'], minmax: ['0', '59'], sym: ['zpn'] },
								fltsett: { event: false }, //eventFromUI disable
								value: '',
								stylize: {
									changeclass: {
